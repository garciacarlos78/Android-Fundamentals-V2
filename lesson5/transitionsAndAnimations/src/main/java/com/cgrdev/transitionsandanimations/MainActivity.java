...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "Transitions Main: ";

    // Name for the intent extra defining the transition type
    ...
    // Order of the icons
    //private ArrayList<String> icon_order = new ArrayList<>(Arrays.asList("square", "android", "line", "ring"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra(TRANSITION_TYPE)) {
            ...
            // Obtain the elements in the current order
            ...
            icon_order = new ArrayList<>(Arrays.asList("square", "android", "line", "ring"));
        }
    }

    private void changeUIorder() {
        // Get UI elements
        ImageButton ring = findViewById(R.id.ring);
        ImageButton android = findViewById(R.id.android);
        ImageButton line = findViewById(R.id.line);
        ImageButton rectangle = findViewById(R.id.rectangle);
