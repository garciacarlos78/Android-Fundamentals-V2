package com.cgrdev.lesson2.shoppinglistmap;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mStoreName = findViewById(R.id.store_text);
  }
  ...
  // Starts a implicit Intent to locate the store
  public void locateStore(View view) {

    // If the store name is empty do nothing
    if (mStoreName.length() == 0) return;

    // Get store name
    String store = "store " + mStoreName.getText().toString();
    // Create Uri
