...
public class NetworkUtils {
    ...
    static String getBookInfo(String queryString) {
        ...
        try {
            ...
            // Close network connection and BufferedReader after finish receiving JSON
