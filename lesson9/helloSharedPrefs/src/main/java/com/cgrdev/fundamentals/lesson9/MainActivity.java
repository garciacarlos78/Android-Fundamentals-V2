package com.cgrdev.fundamentals.lesson9;
...
public class MainActivity extends AppCompatActivity {
    ...
    // Name of the shared preferences file and references to SharedPreferences object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get the count from the preferences. If there are no preferences, it will use 0 as default value
        mCount = mPreferences.getInt(COUNT_KEY, 0);
        mShowCountTextView.setText(String.format("%s", mCount));

        // Get the color from preferences
    ...
    protected void onPause() {
        ...
        // Save the values we want to be restored
